...
class GetCustomerByName extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $name;
    ...
    {
        return str_replace(['{name}'], [$this->name], '/v1/customers/name/{name}');
    }
