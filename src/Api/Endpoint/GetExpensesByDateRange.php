...
class GetExpensesByDateRange extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $startDate;
    protected $endDate;
    ...
    {
        return str_replace(['{startDate}', '{endDate}'], [$this->startDate, $this->endDate], '/v1/expenses/daterange/{startDate}/{endDate}');
    }
