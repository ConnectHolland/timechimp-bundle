...
class GetExpense extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $id;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/v1/expenses/{id}');
    }
