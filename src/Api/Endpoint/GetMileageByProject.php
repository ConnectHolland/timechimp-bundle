...
class GetMileageByProject extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $projectId;
    ...
    {
        return str_replace(['{projectId}'], [$this->projectId], '/v1/mileage/project/{projectId}');
    }
