...
class CreateTime extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    public function __construct(\ConnectHolland\TimechimpBundle\Api\Model\Time $time)
    {
        $this->body = $time;
    }
