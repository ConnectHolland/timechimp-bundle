...
class GetTimeByDateRange extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $startDate;
    protected $endDate;
    ...
    {
        return str_replace(['{startDate}', '{endDate}'], [$this->startDate, $this->endDate], '/v1/time/daterange/{startDate}/{endDate}');
    }
